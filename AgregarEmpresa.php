...
if (isset($_POST['update'])) {
    ...
    , latitud = '$latitud', longitud = '$longitud', domicilio = '$domicilio', email = '$email' 
    WHERE id=$id";
...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <div class="container">
            <a class="navbar-brand" href="Index.php">Agregar Empresa</a>
        </div>
    </nav>
                ...
                <div class="card card-body">
                    ...
                    <div class="card card-body">
                        <form action="GuardarEmpresa.php" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="submit" name="GuardarEmpresa" class="btn btn-success btn-block" value="Guardar Empresa">
                        </form>
                    </div>
                </div>
            </div>
